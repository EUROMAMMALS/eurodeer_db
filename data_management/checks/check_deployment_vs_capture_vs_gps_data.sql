...
WHERE capture_timestamp IS NOT NULL AND capture_result_code not in (2,3)
ORDER BY capture_result_code, a.study_areas_id,  b.animals_id;
...
ORDER BY capture_result_code, a.study_areas_id,  a.animals_id;
...
SELECT y.* FROM y join main.gps_sensors on (gps_sensors.gps_sensors_id = sensor) 
