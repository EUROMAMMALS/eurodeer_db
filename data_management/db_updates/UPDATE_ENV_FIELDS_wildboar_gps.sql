...
TRUNCATE env_data.wildboar_update_gps_update_env_fields;
INSERT INTO env_data.wildboar_update_gps_update_env_fields
...
FROM analysis.external_gps_update_env_fields_wildboar;

-- CORINE raster
UPDATE env_data.wildboar_update_gps_update_env_fields 
...
-- MODIS SNOW 
UPDATE 
env_data.wildboar_update_gps_update_env_fields 
...
FROM
env_data.wildboar_update_gps_update_env_fields a
WHERE 
